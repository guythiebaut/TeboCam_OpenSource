...
namespace TeboCam
{
    class sensitiveInfo
    {
        ...
        public static string newsFile = "yourNews.Zip";//"yourNewsTest.Zip";
        ...
        public static string ApiConnectFile = "\\YourDbaseConnectFile.txt";
        public const string updaterPrefix = "YourUpdaterPrefix";
        public const string dbaseConnectFile = "YourDbaseConnectFile";
