...
You can also get the ready-built executable and pdb files, of the PulseCheck application, from Nuget by running the following from the command line after installing nuget on your machine: 
````
